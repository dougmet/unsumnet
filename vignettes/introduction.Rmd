...
```{r, plot_unsum, fig.show='hold', fig.cap="True network compared to `unsumnet` reconstructed network"}
...
```{r, max_entropy, fig.show='hold', fig.cap="True network compared to maximum entropy network"}
...
This package is under constant development at its [GitHub page](https://www.github.com/dougmet/unsumnet/). Please report any problems/feature requests on the issue tracker there. Other control parameters, such as controlling for known netted positions will be coming soon.